...
Best: **24 physical cores (8P+16E), 1.77 s, 6.52×**. 32 threads (with
P-SMT) regress to 5.81×; 16 E-cores (5.37×) beat 16 P-logical threads
(4.48×). Validation NLL is identical to ~1e-4 across every thread count.
